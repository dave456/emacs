...
(if html-mode-map
  ...
  (define-key html-mode-map "\C-c\C-d" 'html-add-tabent)
  ...
  (define-key html-mode-map "\C-c\C-t" 'html-add-table)
  (define-key html-mode-map "\C-c\C-u" 'html-add-row)
...
;; C-c C-t
(defun html-add-table ()
  "Add a table."
  (interactive)
  (html-open-area "TABLE BORDER"))
